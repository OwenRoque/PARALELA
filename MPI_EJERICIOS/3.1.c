...
int main(int argc, char* argv[]) {
    ...
    comm = MPI_COMM_WORLD;
    e(MPI_Comm_size(comm, &comm_sz)); e(MPI_Comm_rank(comm, &my_rank));
    // get user inputs for // get user inputs for bin_count, max_meas, bin_count, max_meas, min_meas, and data_count min_meas, and data_count
...
/* Get user inputs for Get user inputs for bin_count, max_meas, m bin_count, max_meas, min_meas, and data_count in_meas, and data_count */
void Get_input(
    int* bin_count_p, /* out */
